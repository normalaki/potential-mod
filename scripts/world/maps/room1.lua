      ...
      objects = {
        {
          ...
          properties = {
            ["actor"] = "starwalker",
            ["text1"] = "* This [color:yellow]mod[color:reset] is pissing me off...",
            ["text2"] = "* .[wait:5].[wait:5].[wait:5]",
            ["text3"] = "* Why did you put that [color:yellow]anime guy[color:reset] next to me?",
            ["text4"] = "* I hate you.",
            ["text5"] = "* Go fuck yourself."
          }
        },
        {
          id = 27,
        ...
        },
        {
          ...
          properties = {
            ["actor"] = "dryha",
            ["text1_1"] = "* It's [color:yellow]/home/dryha.[color:reset]\n[wait:5]* Known as [color:yellow]/home/chk_it.[color:reset]",
            ["text1_2"] = "* He is standing here, [wait:5]doing absolutely nothing.",
            ["text2_1"] = "* You wonder why he made this shit mod.",
            ["text2_2"] = "* You wonder why he has an astolfo profile picture.",
            ["text2_3"] = "* You wonder why he pushed this mod to GitHub.",
            ["text2_4"] = "* You wonder why he uses [color:yellow]NixOS.[color:reset]",
