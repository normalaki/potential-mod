return {
    wall = function(cutscene, event)
        ...
        cutscene:text("* The wall seems rather,[wait:20][color:red]PISSED[color:reset] off.")
        ...
        if susie then
            ...
            cutscene:text("* Hey,[wait:5] think I can[wait:10][color:red] PISS[color:reset] on\nthis wall?", "smile")
            ...
            cutscene:wait(1)
            cutscene:text("* Fucking hell.", "angry")
